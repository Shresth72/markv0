...
import (
	...
	"github.com/Shresth72/mark42/command/log"
	"github.com/Shresth72/mark42/pkg/ip"
...
var (
	...
	errARPStdin      = errors.New(
		"ARP cache and IP file can not be read from stdin at the same time",
	)
)
...
func (o *packetScanCmdOpts) initCliFlags(cmd *cobra.Command) {
	...
	cmd.Flags().
		StringVarP(&o.rawInterface, "iface", "i", "", "set interface to send/receive packets")
	cmd.Flags().IPVar(&o.srcIP, "srcip", nil, "set source IP address for generated packets")
	cmd.Flags().
		StringVar(&o.rawSrcMAC, "srcmac", "", "set source MAC address for generated packets")
...
func (o *packetScanCmdOpts) getInterface(
	dstSubnet *net.IPNet,
...
func (o *packetScanCmdOpts) getLocalSubnetInterface(
	dstSubnet *net.IPNet,
) (iface *net.Interface, ifaceIP net.IP, err error) {
	if o.iface == nil {
...
func (o *ipScanCmdOpts) initCliFlags(cmd *cobra.Command) {
	...
	cmd.Flags().
		StringVar(&o.rawGatewayMAC, "gwmac", "", "set gateway MAC address to send generated packets to")
...
func (o *ipScanCmdOpts) getGatewayMAC(
	iface *net.Interface,
	cache *arp.Cache,
) (mac net.HardwareAddr, err error) {
	if o.gatewayMAC != nil {
...
func (o *ipPortScanCmdOpts) initCliFlags(cmd *cobra.Command) {
	...
	cmd.Flags().
		StringVar(&o.portFile, "ports-file", "", "set file with ports or port ranges to scan, one-per line")
}
...
func (o *genericScanCmdOpts) newScanEngine(
	ctx context.Context,
	...
	return scan.NewScanEngine(
		o.newIPPortGenerator(),
		scanner,
		results,
		scan.WithScanWorkerCount(o.workers),
	)
}
