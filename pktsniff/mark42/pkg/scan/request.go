...
func (rg *ipPortGenerator) GenerateRequests(
	ctx context.Context,
	r *Range,
) (<-chan *Request, error) {
...
func (rg *ipRequestGenerator) GenerateRequests(
	ctx context.Context,
	r *Range,
) (<-chan *Request, error) {
	ips, err := rg.ipgen.IPs(ctx, r)
...
func (rg *fileIPPortGenerator) GenerateRequests(
	ctx context.Context,
	r *Range,
) (<-chan *Request, error) {
...
func (rg *liveRequestGenerator) GenerateRequests(
	ctx context.Context,
	r *Range,
) (<-chan *Request, error) {
...
func (rg *filterIPRequestGenerator) GenerateRequests(
	ctx context.Context,
	r *Range,
) (<-chan *Request, error) {
	requests, err := rg.delegate.GenerateRequests(ctx, r)
