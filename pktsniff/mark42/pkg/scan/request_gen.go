// mockgen -package scan -destination=mock_request_test.go -source=request_gen.go PortGenerator,IPGenerator,RequestGenerator,IPContainer
// easyjson -output_filename request_gen_easyjson.go request_gen.go
